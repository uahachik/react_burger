            ...
            <>
                ...
                <section className="my-5 mb-2">
                    ...
                    <div className="col-md-8 float-left bg-light border border-dark">
                        <h4>Construct ME!</h4>
                        <Ingredients ingredients={this.state.ingredients} ingredientsChanged={this.burgerConstructor} />

                        <div className="m-3 border border-secondary p-5" style={{backgroundColor: 'snow'}}>
